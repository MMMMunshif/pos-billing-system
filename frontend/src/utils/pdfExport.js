...
export function downloadProfitReportPdf(rows = [], summary = {}, options = {}) {
  const periodLabel = options.periodLabel || 'Profit Report';
  const generatedAt = new Date().toLocaleString('en-US', {
    year: 'numeric',
    month: 'short',
    day: '2-digit',
  ...
  const productRows = rows.length
        ...
        .map(
          (item, index) => `
            <tr>
              ...
              <td class="right profit">${formatCurrency(item.profit)}</td>
              <td class="right">${formatPercent(item.profitMargin)}</td>
            </tr>
          `
        )
        .join('')
    : `
        <tr>
          <td colspan="8" class="empty">No profit records found</td>
        </tr>
      `;
  ...
  const html = `
    ...
    <html>
      <head>
        <title>${SHOP_NAME} Profit Report</title>
        <style>
          * {
            box-sizing: border-box;
          }
        ...
        <div class="page">
          ...
          <div class="header">
            ...
            <div class="meta">
              ...
              <div class="meta-card">
                <div class="meta-label">Report Type</div>
                <div class="meta-value">Profit Analysis</div>
              </div>
            </div>
          </div>
          ...
          <div class="content">
            <div class="summary">
              ...
              <div class="summary-card purple">
                ...
                <div class="summary-value">${formatCurrency(summary.totalDiscount)}</div>
              </div>
              ...
              <div class="summary-card slate">
                <div class="summary-label">Active Sales</div>
                <div class="summary-value">${Number(summary.activeSalesCount || 0)}</div>
              </div>

              <div class="summary-card blue">
                <div class="summary-label">Sold Quantity</div>
                <div class="summary-value">${Number(summary.totalQuantity || 0)}</div>
              </div>

              <div class="summary-card green">
                <div class="summary-label">Profit Margin</div>
                <div class="summary-value">${formatPercent(summary.profitMargin)}</div>
              </div>

              <div class="summary-card red">
                <div class="summary-label">Cancelled</div>
                <div class="summary-value">${Number(summary.cancelledCount || 0)}</div>
              </div>
            </div>
